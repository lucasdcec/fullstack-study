...
app.post("/submit", (req, res) => {
  let randomNumber_adj = Math.floor(Math.random() * adj.length);
  let selected_adj = adj[randomNumber_adj];
  let randomNumber_noun = Math.floor(Math.random() * noun.length);
  let selected_noun = noun[randomNumber_noun];
